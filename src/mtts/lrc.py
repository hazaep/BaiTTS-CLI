...
def generate_lrc_content(timestamps, texts):
    ...
    for ts, txt in zip(timestamps, texts):
        # Eliminar todas las etiquetas en formato [[...]], haciendo las letras más limpias.
        # Maneja tanto etiquetas de lista negra como instrucciones [[PAUSE:1000]].
